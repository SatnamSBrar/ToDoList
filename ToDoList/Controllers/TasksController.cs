...
namespace ToDoList.Controllers
{
    public class TasksController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TaskID,TaskName,Description,IsCompleted,Date,ListID")] Task task)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TaskID,TaskName,Description,IsCompleted,Date,ListID")] Task task)
        {
            if (ModelState.IsValid)
            {
